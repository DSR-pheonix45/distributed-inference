...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessLayer = channel.unary_unary(
                '/inference.InferenceService/ProcessLayer',
        ...
        self.InitializeWorker = channel.unary_unary(
                '/inference.InferenceService/InitializeWorker',
                request_serializer=inference__pb2.InitRequest.SerializeToString,
                response_deserializer=inference__pb2.InitResponse.FromString,
                _registered_method=True)
        self.Heartbeat = channel.unary_unary(
                '/inference.InferenceService/Heartbeat',
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'InitializeWorker': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=inference__pb2.InitRequest.FromString,
                    response_serializer=inference__pb2.InitResponse.SerializeToString,
            ),
...
class InferenceService(object):
    ...
    def InitializeWorker(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/inference.InferenceService/InitializeWorker',
            inference__pb2.InitRequest.SerializeToString,
            inference__pb2.InitResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
